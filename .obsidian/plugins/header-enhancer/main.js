...
var HeaderEnhancerSettingTab = class extends import_obsidian2.PluginSettingTab {
  ...
  display() {
    ...
    new import_obsidian2.Setting(containerEl).setName("Language [W.I.P]").setDesc("Language for automatic numbering").addDropdown((dropdown) => {
    ...
    new import_obsidian2.Setting(containerEl).setName("Numbering header level").setDesc("The range of header level to be numbered").addToggle((toggle) => {
    ...
    new import_obsidian2.Setting(containerEl).setName(
      "Your auto numbering format is like : 	" + this.plugin.settings.autoNumberingStartNumber + this.plugin.settings.autoNumberingSeparator + "1" + this.plugin.settings.autoNumberingSeparator + "1	from H" + this.plugin.settings.startHeaderLevel + " to H" + this.plugin.settings.maxHeaderLevel + " " + (this.plugin.settings.isAutoDetectHeaderLevel ? "[Auto Detect]" : "[Manual]")
    );
